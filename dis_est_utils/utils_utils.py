...
def create_logger(cfg, cfg_name, phase='train'):
    ...
    shutil.copytree(f'{root_dir}/models/ik_network', tensorboard_log_dir / 'ik_network')	
...
def save_checkpoint(epoch, states, is_best, output_dir, tb_log_dir, filename='checkpoint.pth'):
    ...
    torch.save(states, os.path.join(tb_log_dir, filename))
    if is_best and 'state_dict' in states:
        torch.save(states['best_state_dict'],
                   os.path.join(tb_log_dir, 'model_best.pth'))
